 ...
 * @author Chezis P
 */
public class AddEmployee extends javax.swing.JFrame implements EmployeeDAO {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        String SelectedDPM = cboDepartmentList.getSelectedItem().toString();
        String[] parts = SelectedDPM.split(" : ");
        String name = txtName.getText();
        String age = txtAge.getText();
        String desc = txtDesc.getText();
        int dpmID = Integer.parseInt(parts[0]);
        boolean isSuccess = service.addNewEmployee(name, age, desc, dpmID);
        if ( isSuccess == true ){
            this.dispose();
